        ...
        it 'returns a array with the specific report of survivors' do
            ...
            expect(res).to include(
                { 
                    ...
                    "infecteds" => [
                        {"name" => "Matthew", "age"=>31, "gender"=>"Male", "id"=>6, "infected"=>true, "reports"=>6}, 
                        {"name" => "Kayle", "age"=>42, "gender"=>"Female", "id"=>7, "infected"=>true, "reports"=>4}
                    ]
                }
            ) 
