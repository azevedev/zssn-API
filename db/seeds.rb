...
s.inventory = Inventory.new(capacity: 148)
...
s.inventory = Inventory.new(capacity: 172)
...
s = Survivor.new(name: "Phill", age: "19", gender: "Male", reports: 2)
s.location = Location.new(latitude: 741823, longitude: 4521)
s.inventory = Inventory.new(capacity: 32)
...
s = Survivor.new(name: "Pamn", age: "24", gender: "Female", reports: 1)
s.location = Location.new(latitude: 86357, longitude: 153542)
s.inventory = Inventory.new(capacity: 820)
...
s.location = Location.new(latitude: 452, longitude: 5452)
s.inventory = Inventory.new(capacity: 3150)
s.inventory.items.push(Item.new(name: "water",      value: 4, weight: 2, amount: 3))
...
s.inventory = Inventory.new(capacity: 56)
...
s.inventory = Inventory.new(capacity: 158)
